...
Thresholds are percentile-based (dynamic). Falls back to fixed thresholds if all scores identical.
Tier 1 = top (100 - TIER1_PERCENTILE)% — critical path, full LLM review
...
def assign_tiers(cells: list[dict]) -> list[dict]:
    ...
    logger.info("[tier_assigner] Tiers assigned: %s", {
